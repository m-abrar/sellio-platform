...
| API-backed themes found in source scan | 23 |
| Static / mostly static themes remaining | 29 |
...
| :--- | :--- | ---: |
| Unified | `unifieds_default`, `unifieds_standard`, `unifieds_classic`, `unifieds_modern`, `unifieds_mega`, `unifieds_interactive`, `unifieds_marketplace` | 7 |
...
4. `unifieds_classic`
5. `unifieds_mega`
6. `unifieds_interactive`
7. `unifieds_marketplace`
...
- The previous dynamic report said fifteen dynamic themes while listing sixteen. The source scan now finds 23 API-backed themes.
