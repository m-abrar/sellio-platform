...
| API-backed themes found in source scan | 27 |
| Static / mostly static themes remaining | 25 |
...
| :--- | :--- | ---: |
| Unified | `unifieds_mega`, `unifieds_interactive`, `unifieds_marketplace` | 3 |
...
1. `unifieds_mega`
2. `unifieds_interactive`
3. `unifieds_marketplace`
...
- The previous dynamic report said fifteen dynamic themes while listing sixteen. The source scan now finds 27 API-backed themes.
