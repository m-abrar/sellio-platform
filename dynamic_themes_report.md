...
| API-backed themes found in source scan | 26 |
| Static / mostly static themes remaining | 26 |
...
| :--- | :--- | ---: |
| Unified | `unifieds_classic`, `unifieds_mega`, `unifieds_interactive`, `unifieds_marketplace` | 4 |
...
1. `unifieds_classic`
2. `unifieds_mega`
3. `unifieds_interactive`
4. `unifieds_marketplace`
...
- The previous dynamic report said fifteen dynamic themes while listing sixteen. The source scan now finds 26 API-backed themes.
