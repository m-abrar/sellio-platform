...
| API-backed themes found in source scan | 28 |
| Static / mostly static themes remaining | 24 |
...
| :--- | :--- | ---: |
| Unified | `unifieds_interactive`, `unifieds_marketplace` | 2 |
...
1. `unifieds_interactive`
2. `unifieds_marketplace`
...
- The previous dynamic report said fifteen dynamic themes while listing sixteen. The source scan now finds 28 API-backed themes.
