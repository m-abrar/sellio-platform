# Shopping & Checkout UX Improvements

## Completed

- [x] Added a dynamic header cart badge that updates from the shared cart state and hides when empty.
- [x] Improved cart quantity controls with optimistic updates, disabled syncing states, and button feedback.
- [x] Made the Add to Cart action more noticeable on electronics product pages with a confirmation notice and cart link.
