...
add new addon button needs theme
on the variations tab, the selection column needs to be middle vertically
on the addons tab, the required tab column needs to be middle vertically

---------------

the checkboxes, need to follow theme colors
