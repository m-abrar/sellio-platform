...
export default function ProductPage({ slug }: ProductPageProps) {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const stored = JSON.parse(localStorage.getItem('sellio_properties_platinum_inquiries') || '[]');
      ...
      localStorage.setItem('sellio_properties_platinum_inquiries', JSON.stringify(stored));
      setIsSubmitted(true);
    ...
    return (
      <main className="pl-detail-page">
        <section className="pl-detail-state" role="status">
          ...
          <p>{errorMessage}</p>
          <a href={getThemeLink('')} className="pl-detail-btn">Return to Showcase</a>
        </section>
      </main>
    );
  }
  ...
  return (
    <main className="pl-detail-page">
      <a href={getThemeLink('')} className="pl-detail-back">&larr; Back to Bento Showcase</a>
        ...
        <aside className="pl-detail-sidebar">
          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button className="pl-detail-btn" type="submit">Request Viewing</button>
            </form>
          )}
        </aside>
      </section>
