                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-reviews">
                            @ include('frontend.themes._fallback.default._partials._reviews', ['reviewable' => $brand, 'type' => 'brands'])
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="sticky-top" style="top: 100px;">
                <div class="card glass-surface rounded-5 border-0 shadow-sm p-4 mb-4" data-aos="fade-left">
                    ...
                    <a href="{{ route('dashboard.partner.welcome', ['brand' => $brand->slug]) }}" class="btn btn-primary btn-lg w-100 rounded-pill fw-800 mb-3 shadow-sm">
