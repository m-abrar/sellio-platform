...
<body id="page-top">
    ...
    <section class="page-intro-band bg-hero">
        <div class="container">
            ...
            <p class="lead text-muted">Video guides covering installation, the admin dashboard, selling, buying, and API integration are in production — check back soon for the full library.</p>
        </div>
    </section>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="ratio ratio-16x9">
                    <iframe src="" title="Sellio video" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
