        ...
        <aside class="col-12 col-lg-3">
            <div class="offcanvas-lg offcanvas-start rounded-4 border-0 shadow" tabindex="-1" id="filterSidebar">
                ...
                <div class="offcanvas-body p-0">
                    @include('frontend.themes.services.default._partials._sidebar_filter')
                </div>
            </div>
        </aside>
        ...
        <div class="col-12 col-lg-9">
            ...
            <div class="row g-2 g-md-3 g-lg-4 row-cols-2 row-cols-md-2 row-cols-xl-2"> 
                @forelse($services as $service)
                    <div class="col">
                        @include('frontend.themes.services.default._partials._card', ['service' => $service])
                    </div>
                @empty
            ...
            @if($services->hasPages())
                <div class="mt-5 d-flex justify-content-center">
                    {{ $services->links('frontend.themes.services.default._partials._pagination') }}
                </div>
            @endif
