    ...
    <div class="row g-4 mt-1">
        ...
        <div class="col-lg-8">
                ...
                <div class="p-4 p-lg-5">
                    ...
                    <div class="service-details-content">
                        ...
                        <section id="pricing" class="mb-5">
                            @include('frontend.themes.services.default.show.partials._service_list_bookable', ['service' => $service])
                        </section>
                        ...
                        <section id="availability" class="mb-5 pt-4 border-top border-color-light">
                            ...
                            @include('frontend.themes.services.default.show.partials._operating_hours', ['service' => $service])
                        </section>
            ...
            <div class="related-wrapper pb-5">
                ...
                @include('frontend.themes.services.default.show.partials._related_services', ['relatedServices' => $relatedServices ?? collect()])
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <aside class="sticky-sidebar">
                ...
                @include('frontend.themes.services.default.show.partials.sidebar._booking_sidebar', ['service' => $service])
