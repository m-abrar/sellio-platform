    ...
    <div class="row g-4 mt-1">
                ...
                <div class="p-4 p-lg-5">
                    ...
                    <div class="service-details-content">
                        ...
                        <section id="availability" class="mb-5">
                            ...
                            @include('frontend.themes.services.default.show.partials._operating_hours', ['service' => $service, 'isConsult' => true])
                        </section>

                        {{-- EXPERTISE / FEATURES --}}
                        <section id="expertise" class="mb-5">
                            <h4 class="fw-800 text-dark mb-4 section-title">{{ __('Our Expertise') }}</h4>
                            @include('frontend.themes.services.default.show.partials._simple_feature_list', ['features' => $service->features->take(6)])
                        </section>

                        {{-- MAP --}}
                        <section id="location" class="mb-5 pt-4 border-top border-color-light">
                             <h4 class="fw-800 text-dark mb-4">{{ __('Office Location') }}</h4>
                             @include('frontend.themes.services.default.show.partials._location_map', ['service' => $service, 'isOffice' => true])
                        </section>
        ...
        <div class="col-lg-4">
            <aside class="sticky-sidebar">
                ...
                @include('frontend.themes.services.default.show.partials.sidebar._consultation_sidebar')
