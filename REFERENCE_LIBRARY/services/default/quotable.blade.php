...
<div class="page-content-wrapper py-3 py-lg-4">
    ...
    {{-- 1. NAVIGATION HEADER --}}
    @include('frontend.themes.services.default.show.partials._breadcrumbs', [
    ...
    <div class="row g-4 mt-1">
        ...
        <div class="col-lg-8">
            <div class="card glass-surface border-0 overflow-hidden mb-5">
                ...
                <div class="gallery-section border-bottom border-color-light position-relative">
                    ...
                    @include('frontend.themes.services.default.show.partials._gallery_carousel', ['service' => $service]) 
                </div>

                <div class="p-4 p-lg-5">
                    
                    {{-- 3. SERVICE IDENTITY --}}
                    @include('frontend.themes.services.default.show.partials._listing_header', [
                        'title' => $service->title, 
                    ...
                    <div class="service-details-content">
                        ...
                        <section id="capabilities" class="mb-5">
                            ...
                            @include('frontend.themes.services.default.show.partials._service_list_quotable', ['service' => $service])
                        </section>
                        ...
                        <section id="specs" class="mb-5 pt-4 border-top border-color-light">
                            ...
                            @include('frontend.themes.services.default.show.partials._operating_hours', [
                                'service' => $service
                            ])
                        </section>
                        ...
                        <section id="specs" class="mb-5 pt-4 border-top border-color-light">
                            ...
                            @include('frontend.themes.services.default.show.partials._quick_specs', [
                                'service' => $service,
                        ...
                        <section id="location" class="mb-5 pt-4 border-top border-color-light">
                            <h4 class="fw-800 text-dark mb-4 section-title">{{ __('Location & Directions') }}</h4>
                             @include('frontend.themes.services.default.show.partials._location_map', ['service' => $service])
                        </section>
                        ...
                        <section id="reviews" class="pt-4 border-top border-color-light">
                             ...
                             @include('frontend.themes.services.default.show.partials._reviews_section', [
                                'rating' => number_format($service->rating_average, 1), 
            ...
            <div class="related-wrapper pb-5">
                ...
                @include('frontend.themes.services.default.show.partials._related_services')
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <aside class="sticky-sidebar">
                ...
                @include('frontend.themes.services.default.show.partials.sidebar._quote_sidebar', ['service' => $service])
