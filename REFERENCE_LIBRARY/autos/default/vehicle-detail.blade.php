...
<div class="page-content-wrapper py-3 py-lg-4">
    @include('frontend.themes.autos.default.show.partials._header')
    <div class="row g-4 mt-1">
        ...
        <div class="col-lg-8">
            <div class="card glass-surface border-0 overflow-hidden mb-5 shadow-lg">
                ...
                <div class="p-4 p-lg-5">
                    ...
                    {{-- QUICK SPECS GRID --}}
                    @include('frontend.themes.autos.default.show.partials._quick_specs')
                    ...
                    <div class="property-details-content mt-5">
                        ...
                        <section id="description" class="mb-5">
                            ...
                            <div class="listing-description">
                                @include('frontend.themes.autos.default.show.partials._description')
                            </div>
                        </section>
            ...
            <div class="related-wrapper pb-5">
                 @include('frontend.themes.autos.default.show.partials._related_autos')
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <aside class="sticky-sidebar">
                @include('frontend.themes.autos.default.show.partials._sidebar')
            </aside>
        </div>
    </div>
</div>
