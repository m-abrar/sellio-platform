<div class="features-container">
        ...
        <div class="row g-3">
            @foreach ($auto->features as $feature)
                <div class="col-6 col-md-4">
                    <div class="feature-pill d-flex align-items-center p-2 px-3 rounded-pill bg-glass-light border border-color-light transition-all h-100">
                        <div class="icon-check-wrapper me-2 d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm" 
                            ...
                            <i class="bi bi-check2 text-primary-color" style="font-size: 0.85rem; stroke-width: 2;"></i>
                        </div>
    ...
    @else
        <div class="p-4 rounded-4 bg-glass-light border border-dashed border-color-light text-center">
