                ...
                <div class="col-lg-8">
                    ...
                    <div class="card glass-surface border-0 p-4 p-lg-5 mb-4">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            @include('frontend.themes.events.default.booking._partials._attendee_form', ['booking' => $booking])
                    </div>
                    ...
                    <div class="card glass-surface border-0 p-4 p-lg-5">
                        ...
                        @include('frontend.themes.events.default.booking._partials._payment_options', ['booking' => $booking])
                    </div>
                    ...
                    <div class="ticket-sidebar">
                        <div class="card glass-surface border-0 overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                @include('frontend.themes.events.default.booking._partials._order_summary', ['booking' => $booking])
