...
export default function ListingAnalyticsWidget({ listingId, listingType }: ListingAnalyticsWidgetProps) {
  ...
  if (isLoading) {
    return (
      <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-sm flex flex-col items-center justify-center min-h-[220px]">
        <span className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-300 animate-pulse">Syncing Metrics...</span>
      </div>
    );
  }
  ...
  if (!performance) {
    return (
      <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-sm text-center">
        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">No 30-Day Metrics Registered</p>
        <p className="text-[9px] font-bold text-slate-400 mt-2 leading-relaxed max-w-[200px] mx-auto">This asset has not accumulated traffic or conversion logs within the last 30 days.</p>
      </div>
    );
  }
  ...
  return (
    <div className={`${containerClass} bg-[#6610f2]/5 border-[#6610f2]/10 relative overflow-hidden group animate-in fade-in zoom-in-95 duration-500`}>
      <h4 className="text-[10px] font-black text-[#6610f2] uppercase tracking-[0.25em] mb-8 flex items-center gap-2">
      ...
      <div className="grid grid-cols-2 gap-5 relative z-10">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs flex items-center gap-4 transition-all duration-300 hover:shadow-md hover:scale-[1.02]">
          ...
          <div>
            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Views</p>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs flex items-center gap-4 transition-all duration-300 hover:shadow-md hover:scale-[1.02]">
          ...
          <div>
            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Conversion</p>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-xs flex items-center gap-4 transition-all duration-300 hover:shadow-md hover:scale-[1.02]">
          ...
          <div>
            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Revenue</p>
