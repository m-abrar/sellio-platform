...
import { HiOutlineCheck, HiOutlineClipboardDocument, HiOutlineCog6Tooth, HiOutlineExclamationTriangle } from 'react-icons/hi2';
import {
          ...
          <div className="min-w-0 flex-1 space-y-4">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <div className="rounded-2xl border border-amber-200 bg-white/80 p-4 shadow-sm">
                ...
                <pre className="overflow-x-auto rounded-xl bg-slate-950 p-3 text-xs leading-relaxed text-emerald-300">
                  <code>{snippet}</code>
                </pre>
              </div>
            </div>
            ...
            <ol className="list-decimal space-y-1.5 pl-5 text-sm text-amber-900/90">
              <li>Open <code className="rounded bg-amber-100 px-1.5 py-0.5 font-mono text-xs">config.js</code> in your partner subdomain root (next to <code className="rounded bg-amber-100 px-1.5 py-0.5 font-mono text-xs">index.html</code>).</li>
              <li>Set <code className="rounded bg-amber-100 px-1.5 py-0.5 font-mono text-xs">apiUrl</code> to your Laravel site URL + <code className="rounded bg-amber-100 px-1.5 py-0.5 font-mono text-xs">/api</code>.</li>
            ...
            <p className="flex items-center gap-2 text-xs font-semibold text-amber-800/90">
              ...
              In Laravel admin go to Settings → General, set Partner Portal URL to this panel&apos;s full URL (CORS updates automatically).
            </p>
          </div>
        </div>
      </div>
