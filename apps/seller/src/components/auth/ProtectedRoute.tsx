  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-xs font-black uppercase tracking-caps text-slate-400">Loading session...</p>
      </div>
      </div>
    </div>
  );
...
function AccessDeniedScreen() {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col p-6">
      <SetupReminderBanner />
      <div className="flex flex-1 items-center justify-center">
      <div className="max-w-md w-full bg-white border border-slate-100 rounded-card-lg p-10 text-center shadow-sm">
        ...
        <a
          href="/login"
          className="inline-flex mt-8 px-6 py-3 rounded-2xl bg-slate-900 text-white text-xs font-black uppercase tracking-caps hover:bg-brand transition-colors"
        >
          Back to Login
        </a>
      </div>
