    ...
    return (
      <div className="space-y-10 animate-in fade-in duration-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-7 bg-slate-900 rounded-floating p-12 text-white shadow-2xl relative overflow-hidden flex flex-col justify-between min-h-[400px]">
            ...
            <div className="flex gap-4">
              <div className="flex-1 h-16 bg-slate-800 rounded-card animate-pulse" />
              <div className="flex-1 h-16 bg-slate-800/50 rounded-card animate-pulse" />
            </div>
            <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-brand/10 rounded-full blur-[120px]" />
          </div>
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="bg-slate-50 p-6 sm:p-8 rounded-card-lg border border-slate-100 h-28 flex flex-col justify-between animate-pulse">
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-1000 ease-out">
        ...
        <div className="lg:col-span-7 bg-slate-900 rounded-floating p-12 text-white shadow-2xl relative overflow-hidden flex flex-col justify-between min-h-[400px] transition-all duration-500 hover:scale-[1.01] hover:shadow-purple-900/10">
          <div className="relative z-10 animate-in fade-in slide-in-from-top-4 duration-1000">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-caption font-black uppercase tracking-caps-xl text-slate-500 mb-4">Total Balance</p>
          ...
          <div className="relative z-10 flex gap-4 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-150">
            <button 
              ...
              className="flex-1 bg-brand hover:bg-brand-hover py-6 rounded-card font-black text-xs uppercase tracking-caps transition-all duration-300 flex items-center justify-center gap-3 shadow-lg shadow-purple-900/40 hover:translate-y-[-2px] active:translate-y-[0px]"
            >
              <HiOutlineArrowUpRight className="w-5 h-5" /> Withdraw
            </button>
            <button 
              onClick={() => setIsAddFundsModalOpen(true)}
              className="flex-1 bg-white/10 hover:bg-white/20 backdrop-blur-xl py-6 rounded-card font-black text-xs uppercase tracking-caps transition-all duration-300 flex items-center justify-center gap-3 border border-white/10 hover:translate-y-[-2px] active:translate-y-[0px]"
            >
        ...
        <div className="lg:col-span-5 space-y-8 animate-in fade-in slide-in-from-right-6 duration-1000 delay-100">
          <div className="bg-white p-10 rounded-container border border-slate-100 shadow-premium transition-all duration-500 hover:shadow-premium-hover">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center shadow-sm border border-slate-100">
                        {method.type === 'bank_transfer' ? (
                          <HiOutlineBanknotes className="w-6 h-6 text-brand" />
                        ) : (
                          <HiOutlineCreditCard className="w-6 h-6 text-brand" />
                        )}
                      </div>
                      <div className="flex-1">
                        ...
                        <div className="text-micro font-bold uppercase tracking-widest flex items-center gap-2 mt-1">
                          {method.is_primary ? (
                            <span className="text-brand font-black">Primary Payout</span>
                          ) : (
                            <button 
                              onClick={async () => {
                                try {
                              ...
                              className="text-slate-400 hover:text-brand font-black transition-all cursor-pointer"
                            >
                              Make Primary
                            </button>
                          )}
            ...
            <button 
              ...
              className="w-full mt-8 py-4 border-2 border-dashed border-slate-200 rounded-2xl text-label font-black text-slate-400 uppercase tracking-widest hover:border-brand hover:text-brand transition-all duration-300 hover:bg-brand/5 cursor-pointer"
            >
              + Add New Account
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200">
            <div className="bg-emerald-50 p-6 sm:p-8 rounded-card-lg border border-emerald-100 flex flex-col justify-between transition-all duration-500 hover:shadow-md hover:scale-[1.02]">
              <p className="text-label font-black text-emerald-600 uppercase tracking-widest mb-2">Lifetime Revenue</p>
            ...
            <div className="bg-indigo-50 p-6 sm:p-8 rounded-card-lg border border-indigo-100 flex flex-col justify-between transition-all duration-500 hover:shadow-md hover:scale-[1.02]">
              <p className="text-label font-black text-indigo-600 uppercase tracking-widest mb-2">Completed Payouts</p>
            ...
            <div className="bg-amber-50 p-6 sm:p-8 rounded-card-lg border border-amber-100 flex flex-col justify-between transition-all duration-500 hover:shadow-md hover:scale-[1.02]">
              <p className="text-label font-black text-amber-600 uppercase tracking-widest mb-2">Pending Withdrawals</p>
            ...
            <div className="bg-rose-50 p-6 sm:p-8 rounded-card-lg border border-rose-100 flex flex-col justify-between transition-all duration-500 hover:shadow-md hover:scale-[1.02]">
              <p className="text-label font-black text-rose-600 uppercase tracking-widest mb-2">Rejected Attempts</p>
      ...
      {isWithdrawModalOpen && (
        <div className="fixed inset-0 z-[2000] flex items-center justify-center p-6 animate-in fade-in duration-300">
          ...
          <div className="relative bg-white w-full max-w-lg rounded-floating shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleWithdraw} className="p-10 space-y-8">
              <div>
                <label className="block text-label font-black text-slate-400 uppercase tracking-widest mb-4">Select Payout Method</label>
                {payoutMethods.length === 0 ? (
                  <div className="p-6 border-2 border-dashed border-slate-200 rounded-2xl text-center">
                    ...
                    <button 
                      ...
                      className="text-xs font-black text-brand uppercase tracking-wider underline cursor-pointer"
                    >
                      Link Account Now
                    </button>
                  </div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 border-none rounded-2xl py-5 px-6 text-sm font-bold text-slate-800 focus:ring-2 focus:ring-brand transition-all cursor-pointer"
                    required
                  >
              ...
              <div>
                <label className="block text-label font-black text-slate-400 uppercase tracking-widest mb-4">Amount to Withdraw</label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    step="0.01"
                    min="10.00"
                    className="w-full bg-slate-50 border-none rounded-2xl py-6 pl-12 pr-6 text-2xl font-black text-slate-900 focus:ring-2 focus:ring-brand transition-all"
                    required
                  />
                </div>
                <div className="flex justify-between items-center mt-4 text-label font-bold text-slate-400 uppercase tracking-widest">
              ...
              <button 
                ...
                className="w-full bg-brand text-white py-6 rounded-card font-black text-xs uppercase tracking-caps hover:bg-brand-hover shadow-xl shadow-purple-900/20 transition-all disabled:bg-slate-200 disabled:text-slate-400 disabled:cursor-not-allowed disabled:shadow-none cursor-pointer"
              >
                Confirm Withdrawal
              </button>
            </form>
        ...
        <div className="fixed inset-0 z-[2000] flex items-center justify-center p-6 animate-in fade-in duration-300">
          ...
          <div className="relative bg-white w-full max-w-lg rounded-floating shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleAddAccount} className="p-10 space-y-8">
              <div>
                <label className="block text-label font-black text-slate-400 uppercase tracking-widest mb-4">Payout Method Type</label>
              ...
              {newAccountType === 'bank_transfer' ? (
                <div className="space-y-6">
                  <div>
                    <label className="block text-label font-black text-slate-400 uppercase tracking-widest mb-3">Bank Name</label>
                    <input
                      type="text"
                      value={bankName}
                      onChange={(e) => setBankName(e.target.value)}
                      placeholder="e.g. Chase Bank"
                      className="w-full bg-slate-50 border-none rounded-2xl py-4 px-6 text-sm font-bold text-slate-800 focus:ring-2 focus:ring-brand transition-all"
                      required
                    />
                  </div>
                  <div>
                    <label className="block text-label font-black text-slate-400 uppercase tracking-widest mb-3">Account Number</label>
                    <input
                      type="text"
                      value={accountNumber}
                  ...
                  <div>
                    <label className="block text-label font-black text-slate-400 uppercase tracking-widest mb-3">Routing Number</label>
                    <input
                      type="text"
                      value={routingNumber}
                ...
                <div>
                  <label className="block text-label font-black text-slate-400 uppercase tracking-widest mb-3">PayPal Email Address</label>
                  <input
                    type="email"
                    value={paypalEmail}
              ...
              <button 
                ...
                className="w-full bg-brand text-white py-6 rounded-card font-black text-xs uppercase tracking-caps hover:bg-brand-hover shadow-xl shadow-purple-900/20 transition-all disabled:bg-slate-200 disabled:text-slate-400 cursor-pointer"
              >
        ...
        <div className="fixed inset-0 z-[2000] flex items-center justify-center p-6 animate-in fade-in duration-300">
          ...
          <div className="relative bg-white w-full max-w-lg rounded-floating shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleAddFunds} className="p-10 space-y-8">
              <div>
                <label className="block text-label font-black text-slate-400 uppercase tracking-widest mb-4">Quick Deposit Options</label>
                <div className="grid grid-cols-3 gap-4">
                  {[25, 50, 100].map((amt) => (
                    <button
                      ...
                      className="py-4 bg-slate-50 border border-slate-100 hover:border-brand rounded-2xl text-sm font-black text-slate-700 transition-all hover:bg-purple-50 hover:text-brand cursor-pointer"
                    >
                      +${amt}
                    </button>
                  ))}
              ...
              <div>
                <label className="block text-label font-black text-slate-400 uppercase tracking-widest mb-4">Amount to Deposit</label>
                <div className="relative">
                  <span className="absolute left-6 top-1/2 -translate-y-1/2 text-2xl font-black text-slate-300">$</span>
                  <input 
                    type="number" 
              ...
              <div>
                <label className="block text-label font-black text-slate-400 uppercase tracking-widest mb-4">Card Billing Info (Mocked)</label>
                <div className="p-5 border border-slate-100 bg-slate-50 rounded-2xl flex items-center gap-4">
                  <HiOutlineCreditCard className="w-8 h-8 text-brand" />
                  <div className="flex-1">
                    <p className="text-xs font-black text-slate-800">Visa ending in 4242</p>
                    <p className="text-micro font-bold text-slate-400 uppercase tracking-widest">Instant Top-up Processor</p>
                  </div>
                </div>
              </div>
