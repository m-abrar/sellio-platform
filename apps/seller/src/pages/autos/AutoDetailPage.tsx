    ...
    return (
      <div className="h-screen flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="text-label font-black uppercase tracking-caps-xl text-slate-300">Fetching Vehicle Profile...</span>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-10 md:space-y-16 pb-40 animate-in fade-in slide-in-from-bottom-6 duration-1000">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4 space-y-10">
          ...
          <div className={containerClass}>
            <h4 className="text-label font-black text-slate-400 uppercase tracking-caps mb-8">Vehicle Specifications</h4>
