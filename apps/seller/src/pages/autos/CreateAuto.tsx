          ...
          <div className="relative z-10 max-w-md space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm font-medium text-slate-300 leading-relaxed">
                ...
                Please upgrade your plan to register more vehicle assets.
              </p>
            </div>
            <button 
              type="button"
    ...
    <div className="space-y-10 md:space-y-14 pb-64 lg:pb-48 animate-in fade-in slide-in-from-bottom-6 duration-1000">
      ...
      {isLoading ? (
        <div className="h-64 flex items-center justify-center">
          <span className="text-label font-black uppercase tracking-caps-xl text-slate-300 animate-pulse">Loading Vehicle Form...</span>
        </div>
      ) : (
          ...
          <div className="lg:col-span-8 space-y-8 md:space-y-10">
            <div className={containerClass}>
              <h3 className="text-xl md:text-2xl font-black text-slate-900 tracking-tight italic mb-8 flex items-center gap-3">
                <span className="w-2 h-8 bg-brand rounded-full" /> Vehicle Identity.
              </h3>
            ...
            <div className={containerClass}>
              ...
              {formMeta.features && formMeta.features.length > 0 ? (
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-4 p-5 rounded-2xl border-2 transition-all text-left outline-none ${
                          isChecked
                            ? 'border-brand bg-brand/5 text-brand shadow-brand-glow'
                ...
                <div className="p-8 border-2 border-dashed border-slate-100 rounded-2xl text-center">
                  <p className="text-label font-black uppercase tracking-caps text-slate-400">No active vehicle features found.</p>
                </div>
              )}
            </div>
            ...
            <div className={containerClass}>
              ...
              <div className="bg-slate-50 border-2 border-transparent focus-within:border-brand focus-within:bg-white rounded-card-sm p-4 transition-all flex flex-wrap gap-2.5 items-center">
                {tags.map((tag, idx) => (
                  <span key={idx} className="bg-white border border-slate-100 text-slate-800 text-label font-black uppercase tracking-widest pl-4 pr-3 py-2.5 rounded-full flex items-center gap-2 shadow-sm animate-in zoom-in-50 duration-200">
                    {tag}
                    <button
                      type="button"
            ...
            <div className="lg:sticky lg:top-10 space-y-8">
              <div className="bg-slate-900 rounded-card-lg p-8 md:p-10 text-white shadow-2xl relative overflow-hidden">
                <div className="relative z-10">
                  <p className="text-label font-black uppercase tracking-widest text-slate-500 mb-6">Asset Readiness</p>
