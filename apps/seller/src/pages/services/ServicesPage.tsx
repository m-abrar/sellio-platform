                ...
                <div className="flex items-center justify-between mt-6 pt-6 border-t border-slate-50">
                  ...
                  <div className="flex gap-2">
                    <button 
                      ...
                      className="p-4 bg-slate-50 text-slate-400 rounded-2xl hover:bg-[#6610f2] hover:text-white transition-all"
                    >
                    ...
                    <td className="bg-white group-hover:bg-slate-50/50 border-y border-l border-slate-100 group-hover:border-[#6610f2]/20 rounded-l-[2rem] px-10 py-6 transition-all duration-300">
                      <div className="flex items-center gap-6">
                        ...
                        <div className="min-w-0">
                          ...
                          <span className="text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest bg-[#6610f2]/5 text-[#6610f2] border border-[#6610f2]/10">{service.sku}</span>
                        </div>
                      </div>
                    </td>
                      ...
                      <div className="relative h-16 flex items-center justify-end">
                        <div className="flex flex-col items-end transition-all duration-500 group-hover:opacity-0 group-hover:translate-y-4">
                          <div className="flex items-center gap-2">
                            <span className={`text-[11px] font-black uppercase tracking-widest ${service.is_active ? 'text-green-500' : 'text-amber-500'}`}>{service.is_active ? 'Live' : 'Draft'}</span>
                        ...
                        <div className="absolute inset-y-0 right-0 flex items-center gap-3 opacity-0 translate-y-[-20px] group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
                          <button 
                            onClick={() => navigate(`/dashboard/services/edit/${service.slug}`)}
                            className="p-4 text-slate-400 bg-white rounded-2xl border border-slate-100 hover:bg-[#6610f2] hover:text-white hover:shadow-xl transition-all"
                          >
                            <HiOutlinePencilSquare className="w-5 h-5" />
                          </button>
