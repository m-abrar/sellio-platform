...
export default function Page() {
  const cars = [
    { title: "2018 Honda Civic", price: "$15,500", mileage: "40,000 miles", location: "New York", dealer: "AutoWorld Dealership", image: "/themes/autos/used/5.webp" },
    { title: "2020 Toyota Camry", price: "$19,800", mileage: "25,000 miles", location: "Los Angeles", dealer: "City Motors", image: "/themes/autos/used/6.webp" },
    { title: "2016 Ford Focus", price: "$9,200", mileage: "60,000 miles", location: "Chicago", dealer: "Honest Used Cars", image: "/themes/autos/used/7.webp" },
    { title: "2019 Mazda 3", price: "$17,000", mileage: "30,000 miles", location: "Dallas", dealer: "Zoom Motors", image: "/themes/autos/used/8.webp" },
  ];
    ...
    <div className="autos-used-wrapper">
      ...
      <section className="us-section" style={{ backgroundColor: 'white' }}>
        ...
        <div className="us-deal-card">
            ...
            <div>
                <img src="/themes/autos/used/9.webp" alt="Deal" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
