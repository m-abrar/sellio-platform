...
export default function ProductPage({ slug }: ProductPageProps) {
    ...
    return (
      <main className="ugm-detail-page">
        <section className="ugm-detail-state" role="status">
          <div className="ugm-mono" style={{ color: 'var(--ugm-accent)', marginBottom: '1rem' }}>MEGA_UNAVAILABLE</div>
  ...
  return (
    <main className="ugm-detail-page">
      <a href={themeLink('/')} className="ugm-detail-back">
      ...
      <section className="ugm-detail-grid" aria-labelledby="ugm-detail-page-title">
        ...
        <article className="ugm-detail-panel">
          <div className="ugm-mono" style={{ color: 'var(--ugm-accent)' }}>MEGA_{product.id}</div>
          <h1 id="ugm-detail-page-title">{product.title}</h1>
          <div className="ugm-detail-price">{formatProductPrice(product)}</div>
