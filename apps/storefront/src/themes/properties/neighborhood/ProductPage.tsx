...
export default function ProductPage({ slug }: ProductPageProps) {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const stored = JSON.parse(localStorage.getItem('sellio_properties_neighborhood_inquiries') || '[]');
      ...
      localStorage.setItem('sellio_properties_neighborhood_inquiries', JSON.stringify(stored));
      setIsSubmitted(true);
    ...
    return (
      <main className="pn-detail-page">
        <section className="pn-detail-state" role="status">
          ...
          <p>{errorMessage}</p>
          <a href={getThemeLink('')} className="pn-btn pn-btn-primary">Return to Homes</a>
        </section>
      </main>
    );
  }
  ...
  return (
    <main className="pn-detail-page">
      <a href={getThemeLink('')} className="pn-detail-back">&larr; Back to Neighborly Homes</a>
      ...
      <section className="pn-detail-inquiry">
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button className="pn-btn pn-btn-primary" type="submit">Request Tour</button>
          </form>
        )}
      </section>
    </main>
