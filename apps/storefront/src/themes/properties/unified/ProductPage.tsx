...
export default function ProductPage({ slug }: ProductPageProps) {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const stored = JSON.parse(localStorage.getItem('sellio_properties_unified_inquiries') || '[]');
      ...
      localStorage.setItem('sellio_properties_unified_inquiries', JSON.stringify(stored));
      setIsSubmitted(true);
    ...
    return (
      <main className="uh-detail-page">
        <section className="uh-detail-state" role="status">
          ...
          <p>{errorMessage}</p>
          <a href={getThemeLink('')} className="uh-btn uh-btn-primary">Return to Inventory</a>
        </section>
      </main>
    );
  }
  ...
  return (
    <main className="uh-detail-page">
      <a href={getThemeLink('')} className="uh-detail-back">&larr; Back to Inventory</a>
      ...
      <section className="uh-detail-inquiry">
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button className="uh-btn uh-btn-primary" type="submit">Send Inquiry</button>
          </form>
        )}
      </section>
    </main>
