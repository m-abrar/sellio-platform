...
interface PropertyBookingConfirmPageProps {
...
export default function PropertyBookingConfirmPage({
  classPrefix: prefix,
  themeLink,
}: PropertyBookingConfirmPageProps) {
  ...
  useEffect(() => {
    ...
    api.confirmPropertyBookingPayment(bookingId, gateway, paymentIntent)
      .then((result) => {
