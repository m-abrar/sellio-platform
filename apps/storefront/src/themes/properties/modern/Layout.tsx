...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", color: '#333' }}>
      <header style={{ 
        padding: '1.25rem 5%', 
        display: 'flex', 
        ...
        <div style={{ fontWeight: 800, fontSize: '1.4rem', color: '#1e88e5' }}>
      ...
      <footer style={{ padding: '4rem 5%', borderTop: '1px solid #eee', backgroundColor: '#fafafa', marginTop: '4rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2rem' }}>
          <div>
            <div style={{ fontWeight: 800, fontSize: '1.2rem', color: '#1e88e5', marginBottom: '1rem' }}>Sellio</div>
