...
export default function ProductPage({ slug }: ProductPageProps) {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const stored = JSON.parse(localStorage.getItem('sellio_properties_urban_inquiries') || '[]');
      ...
      localStorage.setItem('sellio_properties_urban_inquiries', JSON.stringify(stored));
      setIsSubmitted(true);
    ...
    return (
      <main className="pu-detail-page">
        <section className="pu-detail-state" role="status">
          ...
          <p>{errorMessage}</p>
          <a href={getThemeLink('')} className="pu-btn pu-btn-primary">Return to Registry</a>
        </section>
      </main>
    );
  }
  ...
  return (
    <main className="pu-detail-page">
      <a href={getThemeLink('')} className="pu-detail-back">&larr; Back to Registry Nodes</a>
      ...
      <section className="pu-detail-inquiry">
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button className="pu-btn pu-btn-primary" type="submit">Submit Inquiry</button>
          </form>
        )}
      </section>
    </main>
