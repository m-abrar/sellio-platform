  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", color: '#333' }}>
      <header style={{ 
        ...
        <div style={{ fontWeight: 800, fontSize: '1.4rem', color: '#4527a0' }}>
          Jobs <span style={{ opacity: 0.5 }}>Platform</span>
        </div>
      ...
      <footer style={{ padding: '4rem 5%', borderTop: '1px solid #eee', backgroundColor: '#fafafa', marginTop: '4rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2rem' }}>
          <div>
            <div style={{ fontWeight: 800, fontSize: '1.2rem', color: '#4527a0', marginBottom: '1rem' }}>Sellio</div>
