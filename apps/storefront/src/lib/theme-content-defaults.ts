...
const EVENTS_CORPORATE_HOME: ThemeContentResponse = {
  ...
  page: 'home',
  content: {
    'header.brand_label': 'SummitPro',
    'header.brand_highlight': 'Pro',
    'hero.eyebrow': 'WORLD ENGINEERING SUMMIT // 2026',
    ...
    'catalog.eyebrow': 'EVENT CATALOG // DIRECTORY',
    'catalog.title': 'Active Summits & Expos',
    'speakers.eyebrow': 'FEATURED SPEAKERS // 2026',
    'speakers.title': 'Distinguished Speakers',
    'agenda.eyebrow': 'CURATED SCHEDULE // DAY 01',
    ...
    'agenda.cta_label': 'BROWSE FULL CATALOG',
    ...
    'cta.button_label': 'RESERVE YOUR PASS',
    'footer.description': 'The premier global platform for corporate summits, technical conferences, and executive forums. Shaping the future of professional events.',
    'footer.email': 'events@summitpro.com',
    'footer.location': 'San Francisco, CA',
    'footer.copyright': '© 2026 SummitPro. All rights reserved.',
    'social.linkedin': 'https://linkedin.com/company/summitpro',
    'social.twitter': 'https://x.com/summitpro',
    'social.instagram': 'https://instagram.com/summitpro',
    'social.youtube': 'https://youtube.com/@summitpro',
  },
  media: {},
  config: {},
};
...
const ECOMMERCE_B2B_HOME: ThemeContentResponse = {
  ...
  page: 'home',
  content: {
    'header.brand_label': 'Aadab International',
    'hero.eyebrow': 'Manufacturers & Exporters - Sialkot, Pakistan',
    'hero.title': 'Orthopedic instruments\nfor global distributors.',
    'hero.description': 'Aadab International manufactures and exports reusable orthopedic surgical instruments from Sialkot, Pakistan for hospitals, distributors, importers, and OEM buyers. Browse the catalog, shortlist items, and request export pricing directly from the factory.',
    'hero.primary_cta_label': 'Browse instruments',
    'hero.secondary_cta_label': 'Request export quote',
    'collection.title': 'Featured orthopedic instruments',
    'collection.description': 'A selection of orthopedic instruments and procedure sets. Each shipment can include material traceability, packing lists, inspection records, and export documentation.',
    'sync.offline_kicker': 'Catalog unavailable',
    'sync.offline_title': 'Products could not be loaded.',
    'empty.title': 'No orthopedic instruments are published yet.',
    'empty.description': 'Add product records in the admin panel and they will appear here.',
    'rfq.title': 'Request an orthopedic export quotation',
    'rfq.description': 'Submit item codes, quantities, stainless-steel grade, finish, private-label needs, destination port, and delivery timeline. Our export team responds within 48 business hours with pricing, lead time, and document options.',
    'footer.brand_label': 'Aadab International',
    'footer.description': 'Aadab International is a Sialkot, Pakistan based manufacturer and exporter of reusable orthopedic surgical instruments for hospitals, importers, distributors, and OEM buyers.',
    'footer.copyright': '(c) 2026 Aadab International. All rights reserved.',
  },
  media: {},
  config: {},
};
