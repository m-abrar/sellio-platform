...
const PROPERTIES_MODERN_HOME: ThemeContentResponse = {
  ...
  page: 'home',
  content: {
    'hero.kicker': 'Premium urban properties',
    ...
    'hero.primary_cta_label': 'Browse properties',
    'hero.secondary_cta_label': 'View featured listings',
    'hero.stat_label': 'Properties listed',
    'precision.kicker': 'Why choose us',
    'precision.title': 'Trusted \nlistings.',
    ...
    'precision.stat_2_label': 'Global coverage',
    'cta.title': 'Ready to \nexplore?',
    'cta.description':
