...
const ECOMMERCE_B2B_HOME: ThemeContentResponse = {
  ...
  content: {
    ...
    'hero.eyebrow': 'Est. 1942 · Surgical Instruments Manufacturer',
    'hero.title': 'Bone Surgery Instruments',
    'hero.description': 'Reusable bone surgery, trauma, spine, and OEM instrument supply for importers, distributors, and hospital purchasing teams.',
    'hero.primary_cta_label': 'View instrument catalog',
    'hero.secondary_cta_label': 'Request a quote',
    'collection.title': 'From the instrument catalog',
    'collection.description': 'A selection from our current export range. Every item is available with your choice of steel grade, finish, marking, and packing. Send an RFQ for exact specifications.',
    'sync.offline_kicker': 'Catalog unavailable',
    'sync.offline_title': 'Products could not be loaded.',
    'empty.title': 'No instruments are published yet.',
    'empty.description': 'Add product records in the admin panel and they will appear here.',
    'rfq.title': 'Ready to place an order?',
    'rfq.description': 'Send your instrument list, quantities, destination country, and any marking, packing, or documentation requirements. Our export team will respond with a complete quotation.',
    'footer.brand_label': 'Aadab International',
    'footer.description': 'Manufacturer and exporter of reusable orthopedic surgical instruments — bone surgery, trauma sets, retractors, elevators, spine instruments, and private-label production.',
    'footer.copyright': '© 2026 Aadab International. All rights reserved.',
  },
  media: {},
  config: {},
};
