...
| API-backed themes | 29 | Themes with live `api.*` usage in `.tsx` files |
| Static / mostly static themes remaining | 23 | No direct live API usage found in theme `.tsx` files |
