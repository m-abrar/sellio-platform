              ...
              <div className="flex-1 flex flex-col min-w-0 h-full bg-zinc-50/10">
                ...
                <div className="p-4 bg-zinc-50/50 border-t border-zinc-150/70">
                  <form onSubmit={handleSend} className="flex gap-2.5 items-center">
                    ...
                    <button 
                      type="button" 
                      title="Add emoji (Demo)"
                      className="p-2.5 bg-white border border-zinc-200 text-zinc-400 hover:text-zinc-650 rounded-xl hover:shadow-2xs transition-all cursor-pointer shrink-0 hidden sm:block"
                    >
                      <Smile size={16} />
                    </button>
