  ...
  return (
    <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 md:mb-16 gap-6">
      ...
      <div className="flex items-center gap-3 w-full md:w-auto">
        {/* We keep the notification bell here as it's a standard header element */}
        <button className="relative p-4 bg-white border border-slate-100 rounded-2xl text-slate-400 shadow-sm hover:text-[#6610f2] transition-all group">
