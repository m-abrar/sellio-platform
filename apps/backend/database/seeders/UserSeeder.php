...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $admin = $this->seedCoreUser('admin@sellio.buzz', 'admin123', [
        ...
        $users[] = $admin;
        $this->command->info('  - Core admin ready: admin@sellio.buzz (admin123)');

        $partner = $this->seedCoreUser('partner@sellio.buzz', 'partner123', [
        ...
        $users[] = $partner;
        $this->command->info('  - Core partner ready: partner@sellio.buzz (partner123)');

        $buyer = $this->seedCoreUser('buyer@sellio.buzz', 'buyer123', [
            'name' => 'Eleanor Vance',
            'email_verified_at' => now(),
        ...
        $users[] = $buyer;
        $this->command->info('  - Core buyer ready: buyer@sellio.buzz (buyer123)');
        $this->command->newLine();
