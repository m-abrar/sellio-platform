    ...
    public function run(): void
    {
        ...
        $baseSettings = [
            ...
            ['group' => 'api', 'key' => 'smart_search_examples', 'value' => json_encode([
                ...
                'BMW electric car for sale',
                'Tesla Model 3 for sale',
                'Mercedes-Benz automatic sedan',
                'global tech summit conference',
                'gourmet food and wine festival near me',
                'SEO and content strategy service',
                'cybersecurity consultation for business',
                'interior design consultation',
                'senior full-stack engineer remote job',
                'data scientist machine learning position',
                'product manager tech company',
                'custom built gaming PC RGB',
                'limited edition vinyl record collection',
                'wireless noise-cancelling headphones',
                'ergonomic standing desk for home office',
                '4K OLED monitor',
                'tips for digital property investment',
            ])],
