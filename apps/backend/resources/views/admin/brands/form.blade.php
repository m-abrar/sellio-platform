                ...
                <div class="card card-primary card-outline shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-0">
                            <label for="description" class="font-weight-600">Brand Description</label>
                            <textarea name="description" id="description" rows="4" 
                                      class="form-control form-control-border @error('description') is-invalid @enderror" 
                                      placeholder="Brief history or details about this brand...">{{ old('description', $brand->description ?? '') }}</textarea>
