    ...
    <form action="{{ $property->exists ? route('admin.properties.update', $property->id) : route('admin.properties.store') }}" 
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="card border-0 shadow-premium rounded-xl overflow-hidden mb-4">
                    ...
                    <div class="card-body p-4 pt-0">
                        <div class="form-group mb-4">
                            <label for="title" class="small font-weight-bold text-muted uppercase mb-2 letter-spacing-1">Property Title <span class="text-danger">*</span></label>
                ...
                <div class="card border-0 shadow-premium rounded-xl overflow-hidden mb-4">
                    <div class="card-header border-0 bg-white py-4 px-4">
                        <h3 class="card-title-main">Specifications & Areas</h3>
                    </div>
                    <div class="card-body p-4 pt-0">
                        <div class="row">
                            <div class="col-md-3">
                ...
                <div class="card border-0 shadow-premium rounded-xl overflow-hidden mb-4">
                    <div class="card-header border-0 bg-white py-4 px-4">
                        <h3 class="card-title-main">Map & Location</h3>
                    </div>
                    <div class="card-body p-4 pt-0">
                        <div class="form-group mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-3"><input type="text" name="city" placeholder="City" class="form-control form-control-premium mb-2" value="{{ old('city', $property->city ?? '') }}"></div>
                            <div class="col-md-3"><input type="text" name="state" placeholder="State/Prov" class="form-control form-control-premium mb-2" value="{{ old('state', $property->state ?? '') }}"></div>
                            <div class="col-md-3"><input type="text" name="country" placeholder="Country" class="form-control form-control-premium mb-2" value="{{ old('country', $property->country ?? '') }}"></div>
                            <div class="col-md-3"><input type="text" name="zip_code" placeholder="Zip Code" class="form-control form-control-premium mb-2" value="{{ old('zip_code', $property->zip_code ?? '') }}"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-premium rounded-xl overflow-hidden mb-4">
                    <div class="card-header border-0 bg-white py-4 px-4">
                        <h3 class="card-title-main">Property Gallery Photos</h3>
                    </div>
                ...
                <div class="card border-0 shadow-premium rounded-xl overflow-hidden mb-4">
                    <div class="card-header border-0 bg-white py-4 px-4">
                        <h3 class="card-title-main mb-0">Tour Requests</h3>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-premium mb-0">
                ...
                <div class="card border-0 shadow-premium rounded-xl overflow-hidden mb-4">
                    <div class="card-header border-0 bg-white py-4 px-4">
                        <h3 class="card-title-main mb-0">Display & Pricing Options</h3>
                    </div>
                    <div class="card-body p-4 pt-0">
                        <div class="row">
                            @php
                                $toggles = [
                                    ['name' => 'is_sale', 'id' => 'isSale', 'label' => 'Available for Sale', 'status' => 'Purchase Listing', 'checked' => old('is_sale', $property->is_sale ?? true)],
                                    ['name' => 'is_rental', 'id' => 'isRental', 'label' => 'Available for Rent', 'status' => 'Lease Listing', 'checked' => old('is_rental', $property->is_rental ?? false)],
                                ];
                            @endphp
