                ...
                <div class="card border-0 shadow-premium rounded-xl overflow-hidden mb-4">
                    ...
                    <div class="card-body p-4 pt-0">
                        <div class="form-group mb-4">
                            <label for="title" class="small font-weight-bold text-muted uppercase mb-2 letter-spacing-1">Feature Name <span class="text-danger">*</span></label>
                            <input type="text" name="title" id="title" 
                                   class="form-control form-control-hero" 
                                   placeholder="{{ __('e.g. Engine Capacity or Experience Level') }}"
                        ...
                        <div class="form-group mb-0">
                            ...
                            <textarea name="description" id="description" rows="4" 
                                      ...
                                      placeholder="{{ __('Briefly describe the purpose of this feature group...') }}">{{ old('description', $feature->description ?? '') }}</textarea>
