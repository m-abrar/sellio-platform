...
<div class="container-fluid pb-5">
    ...
    <div class="card registry-table-card">
        <div class="card-header border-0 bg-white py-4 px-4 d-flex align-items-center">
            <h3 class="card-title font-weight-bold text-dark text-uppercase smallest mb-0 float-none letter-spacing-1">Service Catalog</h3>
                    ...
                    <tbody>
                                    ...
                                    <div class="btn-group btn-group-premium">
                                        ...
                                        <form action="{{ route('admin.services.destroy', $service->id) }}" method="POST" class="d-inline">
                                            ...
                                            <button type="button" class="btn text-danger" 
                                                    data-toggle="tooltip" title="Purge Service"
                                                    data-action="delete-trigger"
                                                    data-confirm-title="Purge Service?"
                                                    data-confirm-text="Permanently delete this service listing?">
                        ...
                        @empty
                            @include('admin._partials._empty-state', [
                                ...
                                'title' => 'No professional services detected.',
                                'description' => 'Synchronize your service board or initialize new service entries to populate this registry.',
                                'button_text' => 'INITIALIZE SERVICE',
