                    ...
                    <tbody>
                        @forelse ($services as $service)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="font-weight-bold text-sm">{{ $service->price_formatted ?? '$0.00' }}</div>
                                </td>
                                ...
                                <td class="text-right align-middle px-4">
                                    <div class="btn-group btn-group-premium shadow-sm">
                                        <a href="{{ route('admin.services.edit', $service->id) }}" class="btn btn-default btn-sm text-info"><i class="fas fa-pencil-alt"></i></a>
                                        <a href="{{ route('admin.services.duplicate', $service->id) }}" class="btn btn-default btn-sm text-success"><i class="fas fa-copy"></i></a>
                                        <form action="{{ route('admin.services.destroy', $service->id) }}" method="POST" class="d-inline">
                                            @csrf @method('DELETE')
                                            <button type="submit" class="btn btn-default btn-sm text-danger" onclick="return confirm('Permanently delete this service listing?')"><i class="fas fa-trash-alt"></i></button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
