    ...
    <form action="{{ $service->exists ? route('admin.services.update', $service->id) : route('admin.services.store') }}" 
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="card border-0 shadow-premium rounded-xl overflow-hidden mb-4">
                    <div class="card-header border-0 bg-white py-4 px-4">
                        <h3 class="card-title-main">{{ __('Service Location') }}</h3>
                    </div>
                    <div class="card-body p-4 pt-0">
                        <div class="form-group mb-4">
                            <label class="small font-weight-bold text-muted uppercase mb-2 letter-spacing-1">{{ __('Address') }}</label>
                            <input type="text" name="address" class="form-control form-control-premium" value="{{ old('address', $service->address ?? '') }}" placeholder="{{ __('Street address or service base') }}">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    <label class="small font-weight-bold text-muted uppercase mb-2 letter-spacing-1">{{ __('City') }}</label>
                                    <input type="text" name="city" class="form-control form-control-premium" value="{{ old('city', $service->city ?? '') }}" placeholder="{{ __('e.g. Austin') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    <label class="small font-weight-bold text-muted uppercase mb-2 letter-spacing-1">{{ __('State') }}</label>
                                    <input type="text" name="state" class="form-control form-control-premium" value="{{ old('state', $service->state ?? '') }}" placeholder="{{ __('e.g. Texas') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-0">
                                    <label class="small font-weight-bold text-muted uppercase mb-2 letter-spacing-1">{{ __('Country') }}</label>
                                    <input type="text" name="country" class="form-control form-control-premium" value="{{ old('country', $service->country ?? '') }}" placeholder="{{ __('e.g. USA') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-0">
                                    <label class="small font-weight-bold text-muted uppercase mb-2 letter-spacing-1">{{ __('Zip Code') }}</label>
                                    <input type="text" name="zip_code" class="form-control form-control-premium" value="{{ old('zip_code', $service->zip_code ?? '') }}" placeholder="{{ __('e.g. 78701') }}">
                                </div>
                            </div>
                        </div>
                    </div>
