...
<div class="container-fluid pb-5">
    ...
    <div class="card registry-table-card">
        <div class="card-header border-0 bg-white py-4 px-4 d-flex align-items-center">
            <h3 class="card-title font-weight-bold text-dark text-uppercase smallest mb-0 float-none letter-spacing-1">Classified Inventory</h3>
                    ...
                    <tbody>
                        ...
                        @empty
                            @include('admin._partials._empty-state', [
                                'colspan' => 6,
                                'icon' => 'fas fa-tags',
                                'title' => 'No ads detected in registry.',
                                'description' => 'Synchronize your marketplace board or initialize new ad entries to populate this registry.',
                                'button_text' => 'INITIALIZE AD',
