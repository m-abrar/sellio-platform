    ...
    <div class="row">
        <div class="col-md-8">
                    ...
                    <form action="{{ route('admin.permissions.store') }}" method="POST" id="permissionForm">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="p-4 bg-light rounded-xl border mt-4">
                                <h6 class="font-weight-bold text-primary text-uppercase mb-2 letter-spacing-1" style="font-size: 0.85rem;"><i class="fas fa-info-circle mr-2 opacity-75"></i>Naming Convention</h6>
            ...
            <div class="card bg-primary-soft border-0 shadow-sm mt-4" style="border-radius: 20px;">
                <div class="card-body p-4">
                    <h5 class="font-weight-bold text-primary text-uppercase mb-3 letter-spacing-1" style="font-size: 0.95rem;"><i class="fas fa-lightbulb mr-2"></i>Security Blueprint Architecture</h5>
