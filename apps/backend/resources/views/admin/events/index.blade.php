                    ...
                    <tbody>
                        ...
                        @empty
                            @include('admin._partials._empty-state', [
                                ...
                                'title' => 'No events detected in schedule.',
                                'description' => 'Synchronize your calendar or initialize new event entries to populate this registry.',
                                'button_text' => 'INITIALIZE EVENT',
