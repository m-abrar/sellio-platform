...
<form action="{{ route('admin.settings.update.group', ['section' => 'social']) }}" method="POST">
    ...
    <div class="card border-0 shadow-premium" style="border-radius: 24px;">
        <div class="card-header bg-white py-4 px-4 border-0">
            ...
            <p class="text-muted smallest font-weight-bold text-uppercase letter-spacing-1 mb-0 mt-1">Manage official social ecosystem links to enhance platform reach and brand authority.</p>
        </div>
