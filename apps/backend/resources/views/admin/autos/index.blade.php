    ...
    <div class="container-fluid pt-4">
        <div class="row mb-4 align-items-center">
            ...
            <div class="col-sm-4 text-right">
                <a href="{{ route('admin.autos.create') }}" class="btn btn-primary rounded-pill px-4 py-2 font-weight-bold shadow-premium smallest uppercase letter-spacing-1">
            ...
            <form action="{{ route('admin.autos.index') }}" method="GET">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3 d-flex align-items-end" style="gap: 10px;">
                        ...
                        <a href="{{ route('admin.autos.index') }}" class="btn btn-default font-weight-bold shadow-xs rounded-pill">
