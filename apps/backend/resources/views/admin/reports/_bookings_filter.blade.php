    ...
    <div class="card-body">
        <form action="{{ url()->current() }}" method="GET" class="row align-items-end">
            <div class="col-md-5 mb-3 mb-md-0">
                <label class="form-label-premium">Analysis Period (Start)</label>
            ...
            <div class="col-md-5 mb-3 mb-md-0">
                <label class="form-label-premium">Analysis Period (End)</label>
                <div class="input-group input-group-premium">
                    <div class="input-group-prepend">
            ...
            <div class="col-md-2">
                <div class="d-flex align-items-center justify-content-end" style="gap: 12px;">
                    ...
                    <a href="{{ url()->current() }}" class="btn-reset-premium" data-toggle="tooltip" title="Reset Range">
