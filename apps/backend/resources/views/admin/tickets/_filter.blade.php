    ...
    <div class="card-body">
        <form method="GET" action="{{ url()->current() }}">
            ...
            <div class="row align-items-end">
                <div class="col-md-5">
                    <label class="form-label-premium">Search Query</label>
                    <div class="input-group input-group-premium">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-search text-xs"></i></span>
                        </div>
                        <input type="text" name="search" class="form-control" placeholder="Search by title, description or ID..." value="{{ request('search') }}">
                    </div>
                </div>
                <div class="col-md-4">
                    <label class="form-label-premium">Priority Level</label>
                    <div class="input-group input-group-premium">
                        <div class="input-group-prepend">
                ...
                <div class="col-md-3">
                    <div class="d-flex align-items-center justify-content-end" style="gap: 12px;">
                        ...
                        <a href="{{ route('admin.tickets.index', ['status' => request('status', 'open')]) }}" class="btn-reset-premium" data-toggle="tooltip" title="Reset Filters">
