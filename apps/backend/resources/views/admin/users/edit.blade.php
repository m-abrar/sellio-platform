                ...
                <div class="card border-0 shadow-premium overflow-hidden rounded-24">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="bg-light p-4 rounded-xl border border-light mb-4">
                            <h6 class="font-weight-bold text-dark mb-3 smallest text-uppercase letter-spacing-1">{{ __('Security Credential Reset') }}</h6>
                            <div class="row">
                                <div class="col-md-6">
            ...
            <div class="col-md-4">
                ...
                <div class="bg-primary-soft p-4 rounded-xl border border-primary-soft shadow-xs">
                    ...
                    <p class="text-muted small mb-0">
                        {{ __('Updating the email or password will force a session termination for the user upon their next interaction with the platform.') }}
                    </p>
                </div>
            </div>
        </div>
