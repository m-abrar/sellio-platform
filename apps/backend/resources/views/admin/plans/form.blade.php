...
@section('title', ($plan->exists ? __('Edit') : __('Create')) . ' ' . __('Plan | Tier Architect'))
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-sm-8">
                <h1 class="m-0 text-dark font-weight-bold">
                    ...
                    {{ $plan->exists ? __('Modify Plan: :title', ['title' => $plan->title]) : __('Add New Tier') }}
                </h1>
                <p class="text-muted mt-2 small text-uppercase letter-spacing-1 mb-0">
                    {{ $plan->exists ? __('Update tier features, pricing structures, and usage quotas.') : __('Define a new subscription offering with distinct benefits and limitations.') }}
                </p>
            </div>
                    ...
                    <ul class="nav nav-pills p-1 bg-white shadow-sm rounded-pill border w-fit" id="planTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active px-4 py-2 rounded-pill font-weight-bold smallest uppercase letter-spacing-1" id="details-tab" data-toggle="tab" href="#details" role="tab">
                                <i class="fas fa-info-circle mr-2"></i> {{ __('Plan Details') }}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-4 py-2 rounded-pill font-weight-bold smallest uppercase letter-spacing-1" id="quotas-tab" data-toggle="tab" href="#quotas" role="tab">
                                <i class="fas fa-list-ol mr-2"></i> {{ __('Quotas & Perks') }}
                            </a>
                        </li>
                    </ul>
                </div>
