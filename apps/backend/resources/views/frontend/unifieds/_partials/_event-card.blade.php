@php
    /** * Using zoom-in for events to differentiate 
     * from the sliding motion of properties/autos.
     */
    $delay = ($iteration ?? 1) * 100;
@endphp

<div class="h-100" data-aos="zoom-in" data-aos-delay="{{ $delay }}">
    <div class="card glass-surface border-0 rounded-5 overflow-hidden hover-lift h-100 text-center p-0 shadow-sm">
        ...
        <div class="card-body p-4 pt-0">
            {{-- User Avatar Floating - Using 'translate-middle-y' for better alignment --}}
