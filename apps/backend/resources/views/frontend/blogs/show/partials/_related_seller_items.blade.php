<div class="row g-3">
    ...
    <div class="col-md-4 col-6">
        <a href="{{ route('partner.profile', $seller->id) }}" class="card bg-white border related-listing-card h-100 text-center d-flex align-items-center justify-content-center text-decoration-none border-dashed">
