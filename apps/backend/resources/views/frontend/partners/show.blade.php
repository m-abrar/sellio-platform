    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="card bg-white border rounded-4 p-2" data-aos="fade-up">
                <div class="card-body">
                    <ul class="nav nav-pills nav-justified mb-4 gap-2 p-2 bg-light rounded-3" id="userTab" role="tablist">
                        <li class="nav-item">
                            <button class="nav-link active rounded-2 fw-semibold" data-bs-toggle="tab" data-bs-target="#tab-all">{{ __('Activity') }}</button>
                        </li>
                        <li class="nav-item">
        ...
        <div class="col-lg-4">
            <div class="sticky-top" sticky-100>
                <div class="card bg-white border rounded-4 p-4 mb-4" data-aos="fade-left">
                    ...
                    <a href="{{ route('conversation.start', $user) }}" class="btn btn-primary btn-header-cta w-100 mb-3">
