<div class="card glass-surface p-0 border-0 shadow-deep overflow-hidden">
    ...
    <div class="px-4 px-lg-5 pb-5 pt-4">
        <div class="mb-4">
            @if($event->category)
                <span class="badge bg-light-primary text-primary-color mb-2 px-3 py-2 rounded-pill fw-bold">
        ...
        <section class="mb-5">
            <h4 class="fw-800 mb-4 text-dark section-title">{{ __('Event Overview') }}</h4>
        ...
        @if($event->schedule_items && $event->schedule_items->count() > 0)
            <section class="mb-5">
                <h4 class="fw-800 mb-4 text-dark section-title">
                    <i class="bi bi-clock-history me-2 text-primary-color"></i>{{ __('Program Schedule') }}
                </h4>
        ...
        @if($event->speakers && $event->speakers->count() > 0)
            <section class="mb-5">
                <h4 class="fw-800 mb-4 text-dark section-title">
                    <i class="bi bi-mic-fill me-2 text-primary-color"></i>{{ __('Featured Speakers') }}
                </h4>
        ...
        @unless($event->is_virtual)
            <section>
                <h4 class="fw-800 mb-4 text-dark section-title">
                    <i class="bi bi-pin-map-fill me-2 text-primary-color"></i>{{ __('Venue Information') }}
                </h4>
                <div class="glass-surface rounded-4 border-0 p-4 mb-4">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-5 text-md-end mt-3 mt-md-0">
                            <a href="https://www.google.com/maps/dir/?api=1&destination={{ $event->latitude }},{{ $event->longitude }}" target="_blank" class="btn btn-outline-primary-theme rounded-pill px-4 fw-bold">
