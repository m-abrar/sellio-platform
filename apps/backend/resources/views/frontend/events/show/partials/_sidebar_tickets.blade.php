<div id="ticket-sidebar" class="ticket-sidebar sticky-sidebar">
    ...
    <div class="detail-sidebar-card mb-4 overflow-hidden">
        <div class="p-4" style="background:#F4F0EC;border-bottom:1.5px solid rgba(15,23,42,.07)">
            <p class="small fw-semibold text-uppercase mb-1" style="letter-spacing:.06em;color:var(--primary-color)">
                <i class="bi bi-calendar-event me-1"></i>{{ __('Event Date') }}
            </p>
            <h4 class="fw-800 text-dark mb-0" style="font-family:var(--font-heading)">{{ __('Select a Date') }}</h4>
        </div>
        <div class="p-4">
    ...
    <div class="detail-sidebar-card overflow-hidden">
        <div class="p-4" style="background:#F4F0EC;border-bottom:1.5px solid rgba(15,23,42,.07)">
            <p class="small fw-semibold text-uppercase mb-1" style="letter-spacing:.06em;color:var(--primary-color)">
                <i class="bi bi-ticket-fill me-1"></i>{{ __('Tickets') }}
            </p>
            <h4 class="fw-800 text-dark mb-0" style="font-family:var(--font-heading)">{{ __('Get Your Tickets') }}</h4>
        </div>
        <div class="p-4">
            ...
            <form id="booking-form" action="" method="POST" class="d-none">
                ...
                <button type="submit" id="checkout-button" class="btn btn-primary btn-header-cta w-100" disabled>
                    <i class="bi bi-cart-fill me-2"></i>{{ __('Proceed to Checkout') }}<i class="bi bi-arrow-right ms-2"></i>
                </button>
            </form>
