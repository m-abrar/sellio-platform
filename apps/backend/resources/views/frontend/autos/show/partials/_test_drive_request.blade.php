...
<div class="card detail-sidebar-card mb-4 overflow-hidden" id="test-drive-widget">
    <div class="p-4" style="background:#F4F0EC;border-bottom:1.5px solid rgba(15,23,42,.07)">
        <p class="small fw-semibold text-uppercase mb-1" style="letter-spacing:.06em;color:var(--primary-color)">
            <i class="bi bi-car-front-fill me-1"></i>{{ __('Test Drive') }}
        </p>
        <h4 class="fw-800 text-dark mb-1" style="font-family:var(--font-heading)">{{ __('Request a Test Drive') }}</h4>
        <p class="small text-muted mb-0">{{ __('Pick a date and the dealer will confirm your slot.') }}</p>
    </div>
