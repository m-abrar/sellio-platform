...
@if ($relatedAutos->isNotEmpty())
    ...
    <div class="mt-5 pt-4">
        <h3 class="fw-bold mb-4"><i class="bi bi-compass-fill me-2 text-primary"></i>{{ __('Similar Vehicles You Might Like') }}</h3>
        ...
        <div class="text-center mt-5">
            <a href="{{ route('autos.index', ['make' => $auto->make]) }}" class="btn btn-lg btn-outline-secondary fw-semibold">
