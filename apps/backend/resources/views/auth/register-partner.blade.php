...
<form method="POST" action="{{ route('register') }}" class="auth-form">
    ...
    <div class="mb-4">
        ...
        <div class="form-icon-group">
            <input type="text" @class(['form-control', 'is-invalid' => $errors->has('name')]) id="name" name="name" value="{{ old('name') }}" placeholder="{{ __('Your name') }}" required autofocus autocomplete="name">
