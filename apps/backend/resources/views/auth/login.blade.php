    ...
    <div class="flex-grow-1 d-flex align-items-center justify-content-center py-5 px-3">
        <div style="width:100%;max-width:440px">
            ...
            <div class="mb-5">
                ...
                <h1 class="mb-3 lh-sm" style="font-size:clamp(1.9rem,4vw,2.6rem)">{{ page_content('auth.login.form_heading', __('Welcome Back')) }}</h1>
                <p class="text-muted fw-medium mb-0 fs-5">{{ page_content('auth.login.form_subheading', __('Sign in to continue shopping and managing your activity.')) }}</p>
            </div>
