...
return [
    ...
    */
    ...
    'logo_img_alt' => 'Admin Dashboard Logo',
    ...
    */
    ...
    'menu' => require config_path('adminlte-menu.php'),
        ...
        'Datatables' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/npm/datatables/jquery.dataTables.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/npm/datatables/dataTables.bootstrap4.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/npm/datatables/dataTables.bootstrap4.min.css',
                ],
            ],
        ],
        'Select2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/npm/select2/select2.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/npm/select2/select2.min.css',
                ],
            ],
        ],
        'Chartjs' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/npm/chart.js/chart.umd.min.js',
                ],
            ],
        ],
        'Sweetalert2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/npm/sweetalert2/sweetalert2.all.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
        ...
        'Pace' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/npm/pace/pace-theme-default.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/npm/pace/pace.min.js',
                ],
            ],
        ],
    ],
