# 🛡️ Sellio Backend: CodeCanyon Qualification Audit
...
| File Path | Score | Audit Status |
| :--- | :--- | :--- |
| `routes\admin.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `routes\api.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `routes\auth.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `routes\channels.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `routes\console.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `routes\web.php` | **80** | ⚠️ Fair - Missing Docblocks |

## Config

| File Path | Score | Audit Status |
| :--- | :--- | :--- |
| `config\activitylog.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\adminlte.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\adminlte-menu.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\app.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\auth.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\broadcasting.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\cache.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\cors.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\database.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\filesystems.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\logging.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\mail.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\permission.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\queue.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\sanctum.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\scramble.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\services.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\session.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `config\theme.php` | **80** | ⚠️ Fair - Missing Docblocks |

## Factories

| File Path | Score | Audit Status |
| :--- | :--- | :--- |
| `database\factories\AutoInquiryFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\EventBookingFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\EventOccurrenceFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\EventTicketTypeFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\OrderFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\ProductAddonFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\ProductFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\ProductMetricFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\ProductOrderFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\ProductSpecificationFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\PropertyAddonFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\PropertyBookingFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\PropertyFeeFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\PropertyNeighborhoodFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\PropertyScoreFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\PropertyVisitFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\ReviewFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\SeasonalPriceFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\SubscriptionFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\TicketFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\TransactionLineFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\UserFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
| `database\factories\WithdrawalFactory.php` | **80** | ⚠️ Fair - Missing Docblocks |
