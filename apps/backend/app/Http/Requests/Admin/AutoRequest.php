...
class AutoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'transmission'     => ['required', 'string', 'in:automatic,manual,semi-automatic,cvt'],
            'fuel_economy'     => ['required', 'string', 'in:petrol,diesel,electric,hybrid,lpg'],
            'drivetrain'       => ['required', 'string', 'in:fwd,rwd,awd,4wd'],
