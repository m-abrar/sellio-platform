    ...
    private function structuredSlotDefaults(string $themeKey): array
    {
        ...
        if ($themeKey === 'jobs_startup') {
            return [
                ...
                ['section' => 'mission', 'content_key' => 'image', 'input_type' => 'image', 'value' => '/themes/jobs/modern/12.webp'],
        ...
        if ($themeKey === 'autos_classic') {
            return [
                ...
                ['section' => 'about', 'content_key' => 'image', 'input_type' => 'image', 'value' => '/themes/autos/modern/1.webp'],
        ...
        $additionalThemeSlots = [
            ...
            'autos_used' => [
                ...
                ['section' => 'deal', 'content_key' => 'image', 'input_type' => 'image', 'value' => '/themes/autos/used/6.webp'],
