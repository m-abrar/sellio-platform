    ...
    private function structuredSlotDefaults(string $themeKey): array
    {
        ...
        $additionalThemeSlots = [
            ...
            'ecommerce_default' => [
                ...
                ['section' => 'hero', 'content_key' => 'eyebrow', 'input_type' => 'text', 'value' => 'New season essentials'],
            ...
            'ecommerce_b2b' => [
                ['section' => 'header', 'content_key' => 'brand_label', 'input_type' => 'text', 'value' => 'Aadab International'],
                ['section' => 'hero', 'content_key' => 'eyebrow', 'input_type' => 'text', 'value' => 'Manufacturers & Exporters - Sialkot, Pakistan'],
                ['section' => 'hero', 'content_key' => 'title', 'input_type' => 'textarea', 'value' => "Orthopedic instruments\nfor global distributors."],
                ['section' => 'hero', 'content_key' => 'description', 'input_type' => 'textarea', 'value' => 'Aadab International manufactures and exports reusable orthopedic surgical instruments from Sialkot, Pakistan for hospitals, distributors, importers, and OEM buyers. Browse the catalog, shortlist items, and request export pricing directly from the factory.'],
                ['section' => 'hero', 'content_key' => 'primary_cta_label', 'input_type' => 'text', 'value' => 'Browse instruments'],
                ['section' => 'hero', 'content_key' => 'secondary_cta_label', 'input_type' => 'text', 'value' => 'Request export quote'],
                ['section' => 'collection', 'content_key' => 'title', 'input_type' => 'text', 'value' => 'Featured orthopedic instruments'],
                ['section' => 'collection', 'content_key' => 'description', 'input_type' => 'textarea', 'value' => 'A selection of orthopedic instruments and procedure sets. Each shipment can include material traceability, packing lists, inspection records, and export documentation.'],
                ['section' => 'sync', 'content_key' => 'offline_kicker', 'input_type' => 'text', 'value' => 'Catalog unavailable'],
                ['section' => 'sync', 'content_key' => 'offline_title', 'input_type' => 'text', 'value' => 'Products could not be loaded.'],
                ['section' => 'empty', 'content_key' => 'title', 'input_type' => 'text', 'value' => 'No orthopedic instruments are published yet.'],
                ...
                ['section' => 'rfq', 'content_key' => 'title', 'input_type' => 'text', 'value' => 'Request an orthopedic export quotation'],
                ['section' => 'rfq', 'content_key' => 'description', 'input_type' => 'textarea', 'value' => 'Submit item codes, quantities, stainless-steel grade, finish, private-label needs, destination port, and delivery timeline. Our export team responds within 48 business hours with pricing, lead time, and document options.'],
                ['section' => 'footer', 'content_key' => 'brand_label', 'input_type' => 'text', 'value' => 'Aadab International'],
                ['section' => 'footer', 'content_key' => 'description', 'input_type' => 'textarea', 'value' => 'Aadab International is a Sialkot, Pakistan based manufacturer and exporter of reusable orthopedic surgical instruments for hospitals, importers, distributors, and OEM buyers.'],
                ['section' => 'footer', 'content_key' => 'copyright', 'input_type' => 'text', 'value' => '(c) 2026 Aadab International. All rights reserved.'],
            ],
