    ...
    private function structuredSlotDefaults(string $themeKey): array
    {
        ...
        $additionalThemeSlots = [
            ...
            'ecommerce_b2b' => [
                ...
                ['section' => 'hero', 'content_key' => 'eyebrow', 'input_type' => 'text', 'value' => 'Orthopedic Surgical Instruments Manufacturer & Exporter'],
                ['section' => 'hero', 'content_key' => 'title', 'input_type' => 'textarea', 'value' => 'Bone Surgery Instruments'],
                ['section' => 'hero', 'content_key' => 'description', 'input_type' => 'textarea', 'value' => 'Reusable bone surgery, trauma, spine, and OEM instrument supply for importers, distributors, and hospital purchasing teams.'],
                ...
                ['section' => 'collection', 'content_key' => 'description', 'input_type' => 'textarea', 'value' => 'A practical catalog for importers, distributors, OEM buyers, and tender suppliers. For exact sizes, finish, marking, packing, and documents, send an RFQ.'],
                ['section' => 'sync', 'content_key' => 'offline_kicker', 'input_type' => 'text', 'value' => 'Catalog unavailable'],
                ['section' => 'sync', 'content_key' => 'offline_title', 'input_type' => 'text', 'value' => 'Products could not be loaded.'],
                ...
                ['section' => 'rfq', 'content_key' => 'description', 'input_type' => 'textarea', 'value' => 'Send item codes, quantities, finish, branding, destination country, and any required documents. We will review the details and reply with pricing, lead time, and practical export options.'],
                ['section' => 'footer', 'content_key' => 'brand_label', 'input_type' => 'text', 'value' => 'Aadab International'],
                ['section' => 'footer', 'content_key' => 'description', 'input_type' => 'textarea', 'value' => 'Aadab International manufactures and exports reusable orthopedic instruments, bone surgery instruments, trauma sets, retractors, elevators, and private-label surgical instruments.'],
