...
class ContentController extends Controller
{
    ...
    {
        foreach (['properties_classic', 'events_music', 'ecommerce_fashion', 'services_marketplace', 'autos_luxury', 'jobs_startup', 'classifieds_general', 'events_classic', 'autos_classic', 'autos_modern', 'autos_used', 'events_creative', 'events_festival', 'autos_electric', 'events_corporate', 'jobs_tech', 'jobs_corporate'] as $themeKey) {
