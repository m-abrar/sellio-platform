...
class MenuService
{
    ...
    protected function fallbackFooterItems(string $locationKey): array
    {
        return match ($locationKey) {
            ...
            'footer_column_3'    => $this->dtoLinks(['About' => '/about', 'Contact' => '/contact']),
            'footer_column_4'    => $this->dtoLinks(['About' => '/about', 'Contact' => '/contact']),
            'company_footer'     => $this->dtoLinks(['About' => '/about', 'Careers' => '#', 'Press' => '#']),
            'support_footer'     => $this->dtoLinks(['Help Center' => '#', 'Contact' => '/contact', 'Status' => '#']),
            'resources_footer'   => $this->dtoLinks(['Documentation' => '#', 'Terms' => '/terms', 'Privacy' => '/privacy-policy']),
